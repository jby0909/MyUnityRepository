...
public class VectorSample2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //크기를 1로 고정하면 벡터의 방향만 고려하면 되어서 다음 연산을 처리하기 쉽기 때문
        //대표적인 예시) 입력으로 캐릭터의 3D이동 진행시 이동이 대각일 경우 일반적인 단일 방향보다 이동속도가 더 빠른 상황이 발생할 수 있음
