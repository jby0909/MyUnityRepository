...
public class PlayerController : MonoBehaviour
{
    ...
    public List<string> anime_list = new List<string> { "PlayerDown", "PlayerUp", "PlayerLeft", "PlayerRight", "PlayerDead"};
    ...
    void Update()
    {
        //플레이 상태가 아니거나, 데미지를 받는 상황에는 로직이 처리되지 않도록 설계
        ...
        z = GetAngle(from, to); // 키 입력을 받은 값을 통해 이동 각도를 계산할 함수 GetAngle
