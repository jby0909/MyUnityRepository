...
public class BasicCode : MonoBehaviour
{
    ...
    //2. 일반클래스 : 유니티 내에서 특정 데이터를 설계할 때 사용
    //3. ScriptableObject가 연결되어 있는 클래스 : 유니티 Assets폴더 내부에 스크립트를 에셋으로 저장할 수 있는 클래스

    //1.접근 제한자(Access modifier)
    //프로그램에서 접근에 관련된 설정을 진행할 수 있는 키워드
    //public : 유니티 인스펙터에서 확인 가능
    //private : 유니티 인스펙터에서 확인 불가
    ...
    void Start()
    {
        ...
        //함수의 ()부분에 작성. ex)Attack(int value)
